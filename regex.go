...
// emailRegex is the RFC 5322-compatible email validation pattern from
// github.com/go-playground/validator. It requires at least one dot in the
// domain (e.g. "gmail.com"), rejecting dotless domains like "gmailcom".
// Trailing whitespace and trailing dots are stripped by Normalize2 before
// this regex is applied, which is the reason this pattern is used instead of
// the go-playground/validator validation directly (it does not support them).
